...
% \setCJKmainfont[BoldFont={Source Han Sans},ItalicFont={Adobe Kaiti Std}]{Source Han Serif}

\usepackage{latexsym,amssymb,amsmath,amsbsy,amsopn,amstext,xcolor,multicol,mathtools}
\usepackage{graphicx,wrapfig,fancybox}
\usepackage{pgf}
\usepackage{zjubeamer}
...
\usepackage[ruled]{algorithm2e} %%format of the algorithm
...
\title{对内存友好的确定性增量梯度方法}
\author[谢嘉豪]{(申请浙江大学工学学士学位论文答辩报告)\vskip 20pt答辩人：谢嘉豪\vskip 5pt指导教师：钱~徽~教授}
\institute[浙江大学~计算机科学与技术学院]{\small \vskip 70pt}
%\date{2015-06-07}
\date{\small \vskip -17pt二〇一八年六月}
%\date{\today}
...
\begin{figure}[htbp]
  \begin{center}
	\includegraphics[width=0.16\linewidth]{ZJU_Logo}
  \end{center}
\end{figure}
%\beign{picture}(1,1)
...
\section{}  % a empty section to hide from the navigation bar
\frame {
  \frametitle{目录}
 % \begin{multicols}{2}
  \tableofcontents
